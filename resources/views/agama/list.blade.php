        ...
        <main>
            ...
            <h1>Data Agama</h1>
                <table width=100% border=1>
                  ...
                  <tr class="tbody">
                    <form action="/agama/create" method="get">
                        <button type="new" class="btn btn-success">Tambah Agama</button>
                    </form>
                    @if ($errors->any())
                  ...
                  <tr>
                    ...
                    <td>{{ $item['agama'] }}</td>
                    <td>
                        <form action="{{ url('/agama/'.$item['id'].'/edit') }}">
                          <button class="btn btn-warning">Edit</button>
                        </form>
                        <form action="{{ url('/agama/'.$item['id']) }}" method="POST" class="d-inline">
                          @csrf
                          @method('delete')
