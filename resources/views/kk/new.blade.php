...
<head>
    ...
    <title>iFamily Card - Menambahkan Kartu Keluarga</title>
        ...
        <main>
          <div class="card">
            ...
            <div class="card-body">
                ...
                @endif
              <form name="formKk" action="/kk" method="post">
                @csrf
                <div class="form-group">
                    <label>No. KK</label>
                    <input type="text" name="nokk" id="nokk" placeholder="Nomor Kartu Keluarga" class="form-control" value="{{ old('nokk') }}">
                  </div>
                  <div class="form-group">
