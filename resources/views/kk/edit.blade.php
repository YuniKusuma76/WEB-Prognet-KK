...
<head>
    ...
    <title>Family Card - Mengedit Data Kartu Keluarga</title>
        ...
        <main>
          <div class="card">
            ...
            <div class="card-body">
                ...
                @endif
              <form name="formKk" action="/kk/{{ $data['id'] }}" method="post">
                @csrf
                @method('PUT')
                  <div class="form-group">
                    <label>No. KK</label>
                    <input type="text" name="nokk" id="nokk" placeholder="Nomor Kartu Keluarga" class="form-control"
                           value="{{ $data['nokk'] }}" readonly>
                  </div>
                  <div class="form-group">
                    <label>Status Aktif</label>
                    <select name="statusaktif" id="statusaktif" class="form-control">
                        <option value="">-- Pilih --</option>
                        <option value="Aktif" @if ($data['statusaktif']=='Aktif'){{ "selected" }} @endif>Aktif</option>
                        <option value="Tidak Aktif" @if ($data['statusaktif']=='Tidak Aktif'){{ "selected" }} @endif>Tidak Aktif</option>
                    </select>
                  </div>
                  <div>
