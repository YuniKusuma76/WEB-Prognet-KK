...
<head>
    ...
    <title>iFamily Card - Menambahkan Data Hubungan Kartu Keluarga</title>
        ...
        <main>
          <div class="card">
            ...
            <div class="card-body">
                ...
                @endif
              <form name="formHubungankk" action="/hubungankk" method="post">
                @csrf
                  <div class="form-group">
                    <label>Hubungan Kartu Keluarga</label>
                    <input type="text" name="hubungankk" id="hubungankk" placeholder="Hubungan Kartu Keluarga" class="form-control">
                  </div>
                  <div>
